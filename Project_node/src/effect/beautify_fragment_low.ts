...
export var beautify_fragment_low = (body:HTMLElement) => {
...
void main(){
  ...
  blurCoordinates[0] = varyUV.xy + singleStepOffset * vec2(5.0, -8.0);
  blurCoordinates[1] = varyUV.xy + singleStepOffset * vec2(5.0, 8.0);
  blurCoordinates[2] = varyUV.xy + singleStepOffset * vec2(-5.0, 8.0);
  blurCoordinates[3] = varyUV.xy + singleStepOffset * vec2(-5.0, -8.0);

  blurCoordinates[4] = varyUV.xy + singleStepOffset * vec2(8.0, -5.0);
  blurCoordinates[5] = varyUV.xy + singleStepOffset * vec2(8.0, 5.0);
  blurCoordinates[6] = varyUV.xy + singleStepOffset * vec2(-8.0, 5.0);
  blurCoordinates[7] = varyUV.xy + singleStepOffset * vec2(-8.0, -5.0);

  blurCoordinates[8] = varyUV.xy + singleStepOffset * vec2(-4.0, -4.0);
  blurCoordinates[9] = varyUV.xy + singleStepOffset * vec2(-4.0, 4.0);
  blurCoordinates[10] = varyUV.xy + singleStepOffset * vec2(4.0, -4.0);
  blurCoordinates[11] = varyUV.xy + singleStepOffset * vec2(4.0, 4.0);
  ...
  sampleColor += texture2D(camera, blurCoordinates[8]).g * 2.0;
  sampleColor += texture2D(camera, blurCoordinates[9]).g * 2.0;
  sampleColor += texture2D(camera, blurCoordinates[10]).g * 2.0;
  sampleColor += texture2D(camera, blurCoordinates[11]).g * 2.0;
