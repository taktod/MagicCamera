...
export var saturation = (body:HTMLElement) => {
...
void main() {
  ...
  var saturationLocation = gl.getUniformLocation(program, 'saturation');
  gl.uniform1f(saturationLocation, 0.5);
  slider.addEventListener("input", () => {
    gl.uniform1f(saturationLocation, Number(slider.value) / 100.0);
  });
