...
export var amaro = (body:HTMLElement) => {
...
void main()
{
  ...
  vec3 bbTexel = texture2D(blowout, varyUV).rgb;
...
`;
  ...
  gl.uniform1i(blowoutLocation, 1);
  ...
  gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, gl.CLAMP_TO_EDGE);
  gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, gl.CLAMP_TO_EDGE);
  gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, document.getElementById('amaromap_png') as HTMLImageElement);
